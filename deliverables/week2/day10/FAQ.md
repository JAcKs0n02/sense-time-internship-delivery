...
- [Day 6 数据源与访问说明](../day6/README.md#2-数据源与固定版本)
- [采集元数据](../day6/source/manifests/collection_metadata.json)
- [Day 6 最终验证](../day6/source/results/day6_validation.json)
...
- [Day 6 格式转换说明](../day6/README.md#4-格式转换规则)
- [原始 ShareGPT 抽样](../day6/source/data/raw/sharegpt_zh_1k.jsonl)，其中原始索引 175 位于文件第 5 行
- [逐样本 provenance](../day6/source/data/interim/day6_provenance.jsonl)，其中该样本位于第 4005 行
- [转换测试](../day6/source/tests/test_day6_pipeline.py)
- [最终验证](../day6/source/results/day6_validation.json)
...
- [Day 8 官方配置来源说明](../day8/README.md#official-configuration-source)
- [同版本官方示例副本](../day8/configs/qwen_lora.official.yaml)
- [逐参数注释配置](../day8/configs/qwen25_7b_week2_lora_annotated.yaml)
- [配置验证结果](../day8/results/config_validation_local.json)
...
- [Day 9 对比说明](../day9/README.md#three-question-evaluation)
- [完整对比结果](../day9/source/results/base_vs_merged_comparison.json)
- [盲评评分](../day9/source/results/evaluation_scores.json)
- [新问题检查](../day9/source/results/evaluation_novelty_check.json)
...
- [Day 8 正式配置](../day8/configs/qwen25_7b_week2_lora_annotated.yaml)
- [SFT 最终摘要](../day8/results/first_sft_summary.json)
...
- [Day 7 最终验证](../day7/source/results/day7_validation.json)
- [Day 8 数据注册](../day8/source/data/dataset_info.json)
- [Day 8 配置验证](../day8/results/config_validation_local.json)
