"""One explicitly bounded eight-request calibration; no retry or GPU usage."""
import datetime
import hashlib
import json
import os
...
def main():
    ...
    assert len(plan['cases']) == plan['max_calls'] == 8
    ...
    try:
        ...
        for index, case in enumerate(plan['cases'], 1):
            ...
            assert body['reasoning_effort'] == 'low' and body['thinking'] == {'type': 'enabled'}
