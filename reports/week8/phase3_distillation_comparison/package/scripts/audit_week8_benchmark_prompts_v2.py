#!/usr/bin/env python3
"""Independent candidate prompt audit v2; reproduces the default empty SYSTEM-to-HUMAN merge newline. Does NOT alone certify runtime."""
import ast
import csv
import hashlib
import json
...
OUT = ROOT / 'reports/week8/phase2_eval_hardening_v2'
